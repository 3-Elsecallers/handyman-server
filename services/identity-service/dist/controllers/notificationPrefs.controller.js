...
const profileValidation_1 = require("../validation/profileValidation");
...
const updatePreferences = async (req, res, next) => {
    try {
        const input = profileValidation_1.updateNotificationPrefsSchema.parse(req.body);
...
//# sourceMappingURL=notificationPrefs.controller.js.map